...
##### To run:
python2 model/lstm_model.py -e --test yiruma\ -\ Love.mxl --note embedding -t --epochs 20 -o midiphrases --num_samples 10 --dropout 0.5 --temperature 0.7 --train_encoder --encoder_epochs 20
